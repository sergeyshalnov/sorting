...
import ru.mail.polis.sort.PartitionQuickSort;

@State(Scope.Thread)
@BenchmarkMode(Mode.AverageTime)
@OutputTimeUnit(TimeUnit.MICROSECONDS)
public class PartitionSortBench {
    ...
    private PartitionQuickSort<Integer> intSort = new PartitionQuickSort<>();
    private PartitionQuickSort<String> strSort = new PartitionQuickSort<>();
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(PartitionSortBench.class.getSimpleName())
                .warmupIterations(5)
