...
import ru.mail.polis.sort.InsertionQuickSort;

@State(Scope.Thread)
@BenchmarkMode(Mode.AverageTime)
@OutputTimeUnit(TimeUnit.MICROSECONDS)
public class InsertionQuickSortBench {
    ...
    private InsertionQuickSort<Integer> intSort = new InsertionQuickSort<>();
    private InsertionQuickSort<String> strSort = new InsertionQuickSort<>();
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(InsertionQuickSortBench.class.getSimpleName())
                .warmupIterations(5)
